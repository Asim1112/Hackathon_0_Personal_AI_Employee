...
class BaseWatcher(ABC):
    ...
    def _register_signals(self) -> None:
        ...
        interpreter.  When a watcher is started by orchestrator.py inside a
        daemon thread, the registration will raise ValueError.  We catch that
        and skip gracefully — the orchestrator's main thread owns shutdown.
        """
        try:
