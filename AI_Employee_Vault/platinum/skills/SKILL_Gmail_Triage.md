...
> ⚠️ **MANDATORY FIELDS — email-mcp will silently skip files missing either of these:**
> - `to: <recipient email address>` — must be the actual email address, not a name
> - `send_via_mcp: email-mcp` — must be this exact value, no variation
